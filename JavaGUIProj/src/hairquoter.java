...
public class hairquoter {
	...
	private void initialize() {
		...
		frmHairProductsCalculator.getContentPane().setForeground(Color.RED);
		frmHairProductsCalculator.getContentPane().setFont(new Font("Dialog", Font.BOLD, 13));
		...
		frmHairProductsCalculator.getContentPane().setBackground(Color.WHITE);
		...
		frmHairProductsCalculator.setBounds(350, 350, 1035, 758);
		...
		pattern_Label.setBackground(Color.LIGHT_GRAY);
		pattern_Label.setFont(new Font("Century", Font.BOLD | Font.ITALIC, 13));
		...
		length_Label.setFont(new Font("Century", Font.BOLD | Font.ITALIC, 13));
		...
		quantity_Label.setFont(new Font("Century", Font.BOLD | Font.ITALIC, 13));
		...
		blondeClosure_Label.setFont(new Font("Dialog", Font.PLAIN, 13));
		blondeClosure_Label.setBounds(28, 436, 180, 14);
		frmHairProductsCalculator.getContentPane().add(blondeClosure_Label);

		JLabel greyClosure_Label = new JLabel("Grey Closure");
		greyClosure_Label.setFont(new Font("Dialog", Font.PLAIN, 13));
		greyClosure_Label.setBounds(28, 461, 180, 14);
		frmHairProductsCalculator.getContentPane().add(greyClosure_Label);

		JLabel straightFrontal_Label = new JLabel("Straight Frontal");
		straightFrontal_Label.setFont(new Font("Dialog", Font.PLAIN, 13));
		straightFrontal_Label.setBounds(28, 486, 180, 14);
		...
		blondeFrontal_Label.setFont(new Font("Dialog", Font.PLAIN, 13));
		blondeFrontal_Label.setBounds(28, 660, 180, 14);
		frmHairProductsCalculator.getContentPane().add(blondeFrontal_Label);

		JLabel greyFrontal_Label = new JLabel("Grey Frontal ");
		greyFrontal_Label.setFont(new Font("Dialog", Font.PLAIN, 13));
		greyFrontal_Label.setBounds(28, 679, 180, 22);
		...
		shippingMethod_Label.setBounds(577, 145, 152, 14);
		...
		subTotal_Label.setBounds(577, 107, 73, 14);
		...
		totals_textArea.setBounds(403, 482, 344, 126);
		
		JLabel selectedProductLabel = new JLabel("Selected products: ");
		selectedProductLabel.setFont(new Font("Consolas", Font.BOLD, 17));
		selectedProductLabel.setBounds(576, 361, 194, 17);
		frmHairProductsCalculator.getContentPane().add(selectedProductLabel);
		
		JLabel totalLabel = new JLabel("Total:");
		totalLabel.setFont(new Font("Consolas", Font.BOLD, 17));
		totalLabel.setBounds(577, 534, 132, 23);
		...
		scrollPane.setBounds(577, 386, 344, 119);
		scrollPane.setViewportView(textArea);
		frmHairProductsCalculator.getContentPane().add(scrollPane);
		
		JScrollPane scrollPane_1 = new JScrollPane();
		scrollPane_1.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_ALWAYS);
		scrollPane_1.setBounds(577, 561, 392, 124);
		scrollPane_1.setViewportView(totals_textArea);
		frmHairProductsCalculator.getContentPane().add(scrollPane_1);
		...
		straightCheckBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(straightCheckBox.isSelected())
				{
		...
		straightButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				{
					straightOrder();
					sub += straight * quantity_Of_Straight;
					quantity_Counter += straightQuantity.getSelectedIndex();
		...
		looseButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				{
					looseOrder();
					sub += loose * quantity_Of_Loose;
					quantity_Counter += looseQuantity.getSelectedIndex();
					subTotal_txtField.setText("$" + Double.toString(sub));
					textArea.append(looseString);
				} else {
					JOptionPane.showMessageDialog(null, "Please check the checkbox before clicking \"add\"");
		...
		deepCheckBox.setBackground(Color.WHITE);
		...
		rareCheckBox.setBackground(Color.WHITE);
		...
		steam1CheckBox.setForeground(Color.RED);
		steam1CheckBox.setBackground(Color.WHITE);
		...
		steam2CheckBox.setForeground(Color.RED);
		steam2CheckBox.setBackground(Color.WHITE);
		...
		blondeCheckBox.setForeground(Color.RED);
		blondeCheckBox.setBackground(Color.WHITE);
		...
		greyCheckBox.setForeground(Color.RED);
		greyCheckBox.setBackground(Color.WHITE);
		...
		strCloCheckBox.setForeground(Color.RED);
		strCloCheckBox.setBackground(Color.WHITE);
		...
		looseCloCheckBox.setForeground(Color.RED);
		looseCloCheckBox.setBackground(Color.WHITE);
		...
		bodyCloCheckBox.setForeground(Color.RED);
		bodyCloCheckBox.setBackground(Color.WHITE);
		...
		deepCloCheckBox.setForeground(Color.RED);
		deepCloCheckBox.setBackground(Color.WHITE);
		...
		rareCloCheckBox.setForeground(Color.RED);
		rareCloCheckBox.setBackground(Color.WHITE);
		...
		steam1CloCheckBox.setForeground(Color.RED);
		steam1CloCheckBox.setBackground(Color.WHITE);
		...
		steam2CloCheckBox.setForeground(Color.RED);
		steam2CloCheckBox.setBackground(Color.WHITE);
		...
		blondeCloCheckBox.setForeground(Color.RED);
		blondeCloCheckBox.setBackground(Color.WHITE);
		...
		greyCloCheckBox.setForeground(Color.RED);
		greyCloCheckBox.setBackground(Color.WHITE);
		...
		strFrontalCheckBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				textArea.append(straightFrontalString);
			}
		});
		strFrontalCheckBox.setForeground(Color.RED);
		strFrontalCheckBox.setBackground(Color.WHITE);
		...
		strFrontalButton.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if(strFrontalCheckBox.isSelected())
				{
					straightFrontalOrder();
					sub += straightFrontal * quantity_Of_StraightFrontal;
					quantity_Counter += straightFrontalQuantity.getSelectedIndex();
					subTotal_txtField.setText("$" + Double.toString(sub));
					textArea.append(straightFrontalString);
				} else {
					JOptionPane.showMessageDialog(null, "Please check the checkbox before clicking \"add\"");
		...
		looseFrontalCheckBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				textArea.append(looseFrontalString);
			}
		});
		looseFrontalCheckBox.setForeground(Color.RED);
		looseFrontalCheckBox.setBackground(Color.WHITE);
		...
		looseFrontalButton.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if(looseFrontalCheckBox.isSelected())
				{
					looseFrontalOrder();
					sub += looseFrontal * quantity_Of_LooseFrontal;
					quantity_Counter += looseFrontalQuantity.getSelectedIndex();
					subTotal_txtField.setText("$" + Double.toString(sub));
					textArea.append(looseFrontalString);
				} else {
					JOptionPane.showMessageDialog(null, "Please check the checkbox before clicking \"add\"");
		...
		bodyFrontalCheckBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				textArea.append(bodyFrontalString);
			}
		});
		bodyFrontalCheckBox.setForeground(Color.RED);
		bodyFrontalCheckBox.setBackground(Color.WHITE);
		...
		bodyFrontalButton.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if(bodyFrontalCheckBox.isSelected())
				{
					bodyFrontalOrder();
					sub += bodyFrontal * quantity_Of_BodyFrontal;
					quantity_Counter += bodyFrontalQuantity.getSelectedIndex();
					subTotal_txtField.setText("$" + Double.toString(sub));
					textArea.append(bodyFrontalString);
				} else {
					JOptionPane.showMessageDialog(null, "Please check the checkbox before clicking \"add\"");
		...
		deepFrontalCheckBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				textArea.append(deepFrontalString);
			}
		});
		deepFrontalCheckBox.setForeground(Color.RED);
		deepFrontalCheckBox.setBackground(Color.WHITE);
		...
		deepFrontalButton.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if(deepFrontalCheckBox.isSelected())
				{
					deepFrontalOrder();
					sub += deepFrontal * quantity_Of_DeepFrontal;
					quantity_Counter += deepFrontalQuantity.getSelectedIndex();
					subTotal_txtField.setText("$" + Double.toString(sub));
					textArea.append(deepFrontalString);
				} else {
					JOptionPane.showMessageDialog(null, "Please check the checkbox before clicking \"add\"");
		...
		rareFrontalCheckBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				textArea.append(rareFrontalString);
			}
		});
		rareFrontalCheckBox.setForeground(Color.RED);
		rareFrontalCheckBox.setBackground(Color.WHITE);
		...
		rareFrontalButton.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if(rareFrontalCheckBox.isSelected())
				{
					rareFrontalOrder();
					sub += rareFrontal * quantity_Of_RareFrontal;
					quantity_Counter += rareFrontalQuantity.getSelectedIndex();
					subTotal_txtField.setText("$" + Double.toString(sub));
					textArea.append(rareFrontalString);
				} else {
					JOptionPane.showMessageDialog(null, "Please check the checkbox before clicking \"add\"");
		...
		steam1FrontalCheckBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				textArea.append(steam1FrontalString);
			}
		});
		steam1FrontalCheckBox.setForeground(Color.RED);
		steam1FrontalCheckBox.setBackground(Color.WHITE);
		...
		steam1FrontalButton.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if(steam1FrontalCheckBox.isSelected())
				{
					steam1FrontalOrder();
					sub += steam1Frontal * quantity_Of_Steam1Frontal;
					quantity_Counter += steam1FrontalQuantity.getSelectedIndex();
					subTotal_txtField.setText("$" + Double.toString(sub));
					textArea.append(steam1FrontalString);
				} else {
					JOptionPane.showMessageDialog(null, "Please check the checkbox before clicking \"add\"");
		...
		steam2FrontalCheckBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				textArea.append(steam2FrontalString);
			}
		});
		steam2FrontalCheckBox.setForeground(Color.RED);
		steam2FrontalCheckBox.setBackground(Color.WHITE);
		...
		steam2FrontalButton.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if(steam2FrontalCheckBox.isSelected())
				{
					steam2FrontalOrder();
					sub += steam2Frontal * quantity_Of_Steam2Frontal;
					quantity_Counter += steam2FrontalQuantity.getSelectedIndex();
					subTotal_txtField.setText("$" + Double.toString(sub));
					textArea.append(steam2FrontalString);
				} else {
					JOptionPane.showMessageDialog(null, "Please check the checkbox before clicking \"add\"");
		...
		blondeFrontalCheckBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				textArea.append(blondeFrontalString);
			}
		});
		blondeFrontalCheckBox.setForeground(Color.RED);
		blondeFrontalCheckBox.setBackground(Color.WHITE);
		...
		blondeFrontalButton.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if(blondeFrontalCheckBox.isSelected())
				{
					blondeFrontalOrder();
					sub += blondeFrontal * quantity_Of_BlondeFrontal;
					quantity_Counter += blondeFrontalQuantity.getSelectedIndex();
					subTotal_txtField.setText("$" + Double.toString(sub));
					textArea.append(blondeFrontalString);
				} else {
					JOptionPane.showMessageDialog(null, "Please check the checkbox before clicking \"add\"");
		...
		greyFrontalCheckBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				textArea.append(greyFrontalString);
			}
		});
		...
		greyFrontalButton.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if(greyFrontalCheckBox.isSelected())
				{
					greyFrontalOrder();
					sub += greyFrontal * quantity_Of_GreyFrontal;
					quantity_Counter += greyFrontalQuantity.getSelectedIndex();
					subTotal_txtField.setText("$" + Double.toString(sub));
					textArea.append(greyFrontalString);
				} else {
					JOptionPane.showMessageDialog(null, "Please check the checkbox before clicking \"add\"");
		...
		greyFrontalButton.setBackground(new Color(0, 0, 51));
		...
		subTotal_txtField.setBounds(654, 101, 99, 24);
		...
		separator_3.setBounds(577, 136, 231, 2);
		...
		UPStxtfield = new JTextField("UPS/USPS Shipping Amount");
		UPStxtfield.setForeground(Color.BLACK);
		UPStxtfield.setSelectionColor(SystemColor.activeCaptionBorder);
		UPStxtfield.setBackground(Color.WHITE);
		...
		UPStxtfield.setBounds(577, 213, 167, 20);
		frmHairProductsCalculator.getContentPane().add(UPStxtfield);
		
		UPS_checkbox = new JCheckBox("UPS/USPS");
		...
		UPS_checkbox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try
				{
					...
					total_With_Shipping = sub + UPS_Amount + quantity_Counter;
				}
				catch(Exception ex)
				{
					ex.printStackTrace();
		...
		UPS_checkbox.setBounds(746, 210, 86, 23);
		...
		calculate_button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
					...
					if(standardshipping_checkbox.isSelected())
						totals_textArea.setText("Total Quantity: " + Integer.toString(quantity_Counter) + " piece(s)\n" 
						+ "Shipping fee: $" + STANDARD_SHIPPING + "(Standard - takes 2-3 days)" + "\n" + "Total WITH PayPal Fee: $" + totalOut + "\n" + "Total WITHOUT PayPal Fee: $" + totalWithOutPaypalFee + paymentInfo());
					if(expressshipping_checkbox.isSelected())
						totals_textArea.setText("Total Quantity: " + Integer.toString(quantity_Counter) + " piece(s)\n" 
								+ "Shipping fee: $" + EXPRESS_SHIPPING + "(Express - takes 1-2 days)" + "\n" + "Total WITH PayPal Fee: $" + totalOut + "\n" + "Total WITHOUT PayPal Fee: $" + totalWithOutPaypalFee + paymentInfo());
		...
		calculate_button.setBounds(618, 256, 152, 74);
		...
		clearButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				straightCheckBox.setSelected(false);looseCheckBox.setSelected(false);bodyCheckBox.setSelected(false);deepCheckBox.setSelected(false);rareCheckBox.setSelected(false);steam1CheckBox.setSelected(false);
				steam2CheckBox.setSelected(false);blondeCheckBox.setSelected(false);greyCheckBox.setSelected(false);strCloCheckBox.setSelected(false);looseCloCheckBox.setSelected(false);bodyCloCheckBox.setSelected(false);
				deepCloCheckBox.setSelected(false);rareCloCheckBox.setSelected(false);steam1CloCheckBox.setSelected(false);steam2CloCheckBox.setSelected(false);blondeCloCheckBox.setSelected(false);greyCloCheckBox.setSelected(false);
				strFrontalCheckBox.setSelected(false);looseFrontalCheckBox.setSelected(false);bodyFrontalCheckBox.setSelected(false);deepFrontalCheckBox.setSelected(false);rareFrontalCheckBox.setSelected(false);steam1FrontalCheckBox.setSelected(false);
				steam2FrontalCheckBox.setSelected(false);blondeFrontalCheckBox.setSelected(false);greyFrontalCheckBox.setSelected(false);
				...
				textArea.setText(""); totals_textArea.setText("");
				sub = 0;
		...
		clearButton.setBounds(868, 268, 101, 53);
	...
	{
		String info = "\nZelle info (no fee): 401-499-0419\n"
				+ "Cash App info (no fee): $joshswift12\n"
				+ "PayPal info (fee is applied): kingdomofwonder178@gmail.com";
		return info;		
	}
}
